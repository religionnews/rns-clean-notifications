<?php
/*
Plugin Name: RNS Clean Notifications
Plugin URI: http://github.com/religionnews/rns-clean-notifications
Description: A fork of Mike Davidson's plugin that makes e-mail notifications for new comments/pings cleaner and more readable. No configuration necessary.
Author: David Herrera, Mike Davidson
Version: 1.0
Author URI: http://www.religionnews.com/
*/

/*
    Copyright 2013 Religion News LLC and Mike Davidson
...
function wp_notify_postauthor($comment_id, $comment_type='') {
	...
	$notify_message .= sprintf( __('<a href="http://www.whatsmyip.org/ip-geo-location/?ip=%1$s">Look up IP</a><br /><br />'), $comment->comment_author_IP );			
